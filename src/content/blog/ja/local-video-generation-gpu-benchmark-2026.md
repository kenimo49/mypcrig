...
画像生成側のベンチマークは「[Stable Diffusion XL / Flux.1 画像生成速度 GPU別ベンチマーク 2026年版](/blog/sdxl-flux-image-generation-gpu-benchmark-2026/)」で扱っています。動画生成は画像生成と比べて **VRAM 要件が 3〜10 倍** に増えるため、GPU 選定の前提が大きく変わります。
