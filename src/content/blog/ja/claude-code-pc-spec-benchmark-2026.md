---
title: "Claude Code を快適に動かすPC構成 2026年版 — メモリ・CPUの実測影響と必要スペック"
...
ローカル LLM 推論の話は別記事「[ローカルLLMを動かすPCの最低スペック 2026年版](/blog/ja/local-llm-pc-spec-2026/)」を見てください。本記事はあくまで「クラウド側で推論しているのに、なぜ自分のPCが重くなるか」を扱います。
...
Apple Silicon の **Unified Memory** は、CPU と GPU が同じメモリ空間を共有する設計です。Windows ノートで「メモリ→GPU メモリ」のコピーが発生する処理が Mac では不要になるため、同じメモリ容量でも体感の余裕があります。詳しい解説は「[Apple Silicon Unified Memory vs NVIDIA VRAM 2026年版](/blog/ja/unified-memory-vs-nvidia-vram-llm-2026/)」を参照してください。
...
- [ローカルLLMを動かすPCの最低スペック 2026年版](/blog/ja/local-llm-pc-spec-2026/) — クラウドAI ではなく、ローカル推論を動かしたい場合
- [Apple Silicon Unified Memory vs NVIDIA VRAM 2026年版](/blog/ja/unified-memory-vs-nvidia-vram-llm-2026/) — Mac の Unified Memory がなぜ有利かの詳細

法人で Claude Code を含む AI開発環境を構築する方は [propel-lab](https://propel-lab.co.jp) へ。
